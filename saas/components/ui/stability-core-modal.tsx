...
interface StabilityCoreModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const StabilityCoreModal: React.FC<StabilityCoreModalProps> = ({ 
  isOpen, 
  onClose, 
  onSuccess, 
  onError
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/create-stability-core-flow', {
        method: 'POST',
        headers: {
...
export default StabilityCoreModal;
