    ...
    <main className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#2A0148' }}>
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Core Plan Success!</h1>
          <p className="text-white/80 text-lg">Your Core Plan subscription is now active</p>
        </div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const resp = await fetch('/api/meter-Event38', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                      customerId,
