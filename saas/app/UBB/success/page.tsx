          ...
          {data && (
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="rounded-xl border border-gray-200 bg-white p-6">
                  <div className="grid sm:grid-cols-3 gap-4">
                    <button className="action bg-blue-700 text-white hover:bg-blue-800" onClick={() => setOpenAiModal(true)}>Input Open AI Usage</button>
                    <button className="action bg-blue-700 text-white hover:bg-blue-800" onClick={() => setClaudeModal(true)}>Input Claude Usage</button>
                    <button className="action bg-blue-700 text-white hover:bg-blue-800" onClick={() => setGrokModal(true)}>Input Grok Usage</button>
                  </div>
                </div>
              </section>
            </div>
