...
const countries = [
  { code: 'US', name: 'United States of America', tableId: 'prctbl_1RaegnPMHvg98WVIroeEDkse' },
  { code: 'GB', name: 'United Kingdom', tableId: 'prctbl_1RadL2PMHvg98WVIRI13F9i7' },
  { code: 'IN', name: 'India', tableId: 'prctbl_1RaehxPMHvg98WVIilKcWEF6' },
  { code: 'IT', name: 'Italy', tableId: 'prctbl_1Raej2PMHvg98WVIJVcDDNK6' },
];
