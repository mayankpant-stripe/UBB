...
Payment link has been sent to your email address.`;
  ...
  useEffect(() => {
    ...
    ws.onmessage = (event) => {
        console.log('WebSocket message:', event.data + "I am meena"); // Add this line
...
Your Finance course enrollment is complete!`);
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#2A0148' }}>
      ...
      <section className="py-16 lg:py-24" style={{ backgroundColor: '#2A0148' }}>
      ...
      <section className="py-8" style={{ backgroundColor: '#2A0148' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
