...
const countries = [
  { code: 'US', name: 'United States of America', tableId: 'prctbl_1RaxUKPMHvg98WVIUOMX2UTD' },
  { code: 'GB', name: 'United Kingdom', tableId: 'prctbl_1RaxRfPMHvg98WVIIjdRJSl7' },
  { code: 'IN', name: 'India', tableId: 'prctbl_1RaxT5PMHvg98WVIMKypFJHM' },
  { code: 'IT', name: 'Italy', tableId: 'prctbl_1RaxUiPMHvg98WVIj6LdOXnf' },
];
