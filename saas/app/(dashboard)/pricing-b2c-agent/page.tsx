...
export default function PricingB2CAgentPage() {
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: '#2A0148' }}>
      ...
      {/* ElevenLabs Voice AI Widget - Bottom Right */}
      <div className="fixed bottom-4 right-4 z-50">
        <div 
          id="voice-agent-widget" 
          dangerouslySetInnerHTML={{
            __html: `
              <elevenlabs-convai 
                agent-id="agent_01jza98qggfc7rvxzbqs8r93d9"
                variant="floating"
      ...
      {/* Load ElevenLabs ConvAI Widget SDK */}
      <script
        dangerouslySetInnerHTML={{
          __html: `
            (function() {
              ...
              script.onload = function() {
                console.log('✅ ElevenLabs Voice AI Widget loaded successfully');
              };
              
              script.onerror = function() {
                console.error('❌ Failed to load ElevenLabs Voice AI Widget');
              };
