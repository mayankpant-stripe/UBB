              ...
              <section>
                ...
                <div className="rounded-xl p-6 border-2 border-gray-300" style={{ backgroundColor: 'white' }}>
                  <div className="flex justify-center">
                    <button className="action bg-blue-700 text-white hover:bg-blue-800" onClick={() => setOpenAiModal(true)}>Input OnaCore</button>
                  </div>
                </div>
              </section>
            </div>
            ...
            <form
              onSubmit={async (e) => {
                ...
                try {
                  ...
                  const resp = await fetch('/api/meter-onacore', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                      customerId,
