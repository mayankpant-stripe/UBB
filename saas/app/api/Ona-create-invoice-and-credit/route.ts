...
export async function POST(request: NextRequest) {
  try {
    ...
    // Step 5: Create credit grant
    console.log('Creating credit grant with form-encoded payload for customer:', customerId, 'creditAmount:', creditAmount);

    // Create form-encoded body for Stripe API
    const formBody = new URLSearchParams();
    formBody.append('amount[custom_pricing_unit][id]', 'cpu_test_61TOlfks2rE3rlvCl16T5kls95SQJJF9DR1pbaQwq8Bk');
    formBody.append('amount[custom_pricing_unit][value]', creditAmount.toString());
